        ...
        <div class="detbox">
            ...
            <div class="detmain" style="text-align: center">
                ...
                <form id="registerForm" method="POST" enctype="multipart/form-data" action="register.jsp">
                    <div class="left sidesbox">
                        <div class="txtfieldbox" style="border-top: 0; padding-top: 0">
                            <div class="left txtboxlabel">USERNAME</div>
                            <div class="right">
                                <input class="txtfield" id="username-input" type="text" size="30" name="username" value="<% if (user.username != null) out.println(user.username); %>" onkeyup="checkAvailabilityUsername('<?php echo BASE_URL?>')" />
                            </div>
                            <div class="clear"></div>
                            <div class="error" id="usernameError"><!--% if (user.usernameError != null) out.println(user.usernameError); %--></div>
                        </div>
                        <div class="txtfieldbox">
                            ...
                            <div class="clear"></div>
                            <div class="error" id="nameError"><!--% if(user.errorName != null) out.println(user.errorName); %--></div>
                        </div>
                        <div class="txtfieldbox">
